...
export function concat<V1, I1, E1 extends DomainError, R1>(
	s2: Source<V1, I1, E1, R1, Pull>,
): <V2, I2, E2 extends DomainError, R2>(
...
export function concat<
	V1,
	I1,
	E1 extends DomainError,
	R1,
	P extends AnyPullPush,
>(s2: Source<V1, I1, E1, R1, P>) {
	return function <V2, I2, E2 extends DomainError, R2>(
